package microservices.book.gamification.game.service.impl;
...
import microservices.book.gamification.game.service.LeaderBoardService;
...
class LeaderBoardServiceImpl implements LeaderBoardService {
    ...
    public List<LeaderBoardRow> getCurrentLeaderBoard() {
        ...
        // Combine with badges
        return scoreOnly.stream().map(row -> { List<String> badges =
